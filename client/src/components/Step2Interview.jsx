...
function Step2Interview({ interviewData, onFinish }) {
  ...
  }, [selectedVoice, isIntroPhase, currentIndex, currentQuestion, questions.length, userName, speakText, startMic])
  ...
  }, [interviewId, currentIndex, answer, currentQuestion, timeLeft, isSubmitting, speakText, stopMic])
  ...
  const handleNext = async () => {
    ...
    const nextTimeLeft = questions[currentIndex + 1]?.timeLimit || 60;
